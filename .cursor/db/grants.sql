-- Grant app roles access to ODS and DW schemas.
...
GRANT ALL ON SCHEMA orion_ods TO orion_app;
GRANT ALL ON ALL TABLES IN SCHEMA orion_ods TO orion_app;
GRANT ALL ON ALL SEQUENCES IN SCHEMA orion_ods TO orion_app;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA orion_ods TO orion_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA orion_ods GRANT ALL ON TABLES TO orion_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA orion_ods GRANT ALL ON SEQUENCES TO orion_app;

GRANT USAGE ON SCHEMA orion_dw TO orion_app;
GRANT ALL ON ALL TABLES IN SCHEMA orion_dw TO orion_app;
GRANT ALL ON ALL SEQUENCES IN SCHEMA orion_dw TO orion_app;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA orion_dw TO orion_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA orion_dw GRANT ALL ON TABLES TO orion_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA orion_dw GRANT ALL ON SEQUENCES TO orion_app;
